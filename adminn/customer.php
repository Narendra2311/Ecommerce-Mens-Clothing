...
$query = "SELECT c.c_id, c.c_name, c.c_phonenumber, c.c_emailid, ca.address, ca.country, ca.state, ca.city, ca.zip_code 
          FROM customer c
          LEFT JOIN customer_addresses ca ON c.c_id = ca.customer_id
          GROUP BY c.c_id";
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    <td><?php echo $row['c_phonenumber'] ?></td>
                                                    <td><?php echo $row['c_emailid'] ?></td>
                                                    <td>
                                                        <?php
